...
// function main () {
    ...
    alert("I made it past the capitals")
    ...
    var $inputMessage = document.getElementById('.inputMessage'); // Input message input box
    ...
    setInterval(function getLocation () {
        userLocation = localStorage.location;
        alert(userLocation);
    }, 5000);
...
function isFriendAccessible(friend) {
...
//check if user is online or nearby. 
//